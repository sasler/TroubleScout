...
- To work on {{effectivePrimary}}, use `run_powershell` with sessionName: "{{effectivePrimary}}" for small, bounded reads and delegate `run_delegated_powershell` only for high-volume evidence
