...
3. **Required Status Checks**: The following checks must pass before merging:
   ...
   - ✅ Tests workflow (Windows and Ubuntu)
...
1. **Title**: Must start with an emoji or conventional commit type
   - Example: `✨ Add network diagnostics tool`
...
├── TroubleshootingSession.cs   # Copilot SDK integration
├── Services/                   # Infrastructure services
│   ├── PowerShellExecutor.cs   # Command execution
│   └── WinRMConnection.cs      # Remote connectivity
├── Tools/                      # AI tool functions
│   └── DiagnosticTools.cs      # Diagnostic capabilities
├── UI/                         # User interface
│   └── ConsoleUI.cs            # Spectre.Console TUI
└── TroubleScout.Tests/         # Unit tests
```
