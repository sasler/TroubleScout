...
If `WINGET_TOKEN` and a `winget-pkgs` fork are configured, a separate **Publish to WinGet** workflow also runs after the **Release** workflow completes to open or update the WinGet manifest PR automatically.
