...
internal static class SlashCommandRegistry
{
    ...
    [
        ...
        new(Configuration, "/byok env|<api-key> [base-url] [model]", "Enable OpenAI-compatible BYOK mode without GitHub authentication.", ["/byok"],
            [
        ...
        new(Configuration, "/byok clear", "Clear saved BYOK settings for this profile.", []),
